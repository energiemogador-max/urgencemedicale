...
export const AR: TranslationPart[] = [misc, cities, specialties, services, situations, serviceCities, citySpecialties, situationCities, quartiersCasablanca1, quartiersCasablanca2, quartiersCasablanca3, quartiersCasablanca4, quartiersCasablanca5, quartiersRabat1, quartiersRabat2, quartiersMohammedia, quartiersCote];

          ...
          <tbody>
            {pricing.tiers.map((t) => (
              <tr key={t.slug} className="border-b border-border last:border-0">
                <td className="px-2 py-2.5 text-[0.95rem] font-semibold sm:px-4 sm:py-3 sm:text-base">{t.label}</td>
                <td className="px-2 py-2.5 text-[0.85rem] text-ink-muted sm:px-4 sm:py-3 sm:text-base">{t.window}</td>
                <td className="px-2 py-2.5 text-[0.95rem] font-bold whitespace-nowrap tabular-nums text-primary sm:px-4 sm:py-3 sm:text-lg">

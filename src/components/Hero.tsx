...
/**
 * Deep-green panel carrying the cross weave — the site's one bold moment.
...
export function Hero({
  ...
  return (
    <section className="cross-weave rise overflow-hidden rounded-2xl bg-primary px-5 py-8 text-white sm:px-8 sm:py-12">
      {badge && (
